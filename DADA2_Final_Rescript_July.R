...
baseFolder <- "~/Desktop/DukeREU/FastQ_Files/Micro_F/Combined/Naming2"
CSVFile <- "~/Desktop/DukeREU/FastQ_Files/Micro_F/Combined/Metadata/Metadata.csv"


outputFiltered <- "~/Desktop/DukeREU/FastQ_Files/Micro_F/Combined/filtered"
output.dir <- "~/Desktop/DukeREU/FastQ_Files/Micro_F/Combined/output"
...
sampleTable = transform(sampleTable, SampleName = as.character(SampleName), 
                        Week = as.character(Week), Type = as.character(Type))

matchtable <- sampleTable
colnames(matchtable) <- c("SampleName","Week", "Type")
...
plot_richness(ps, x="Week", color="Type")