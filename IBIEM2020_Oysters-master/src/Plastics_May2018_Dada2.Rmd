...
outputFiltered <- "/sharedspace/oysters/plastics/scratch/filtered_May2018"
output.dir <- "/sharedspace/oysters/plastics/output"
ps.file <- file.path(output.dir,"ps_plastics_May2018.rds")
track.file <- file.path(output.dir,"track_plastics_May2018.rds")
```
